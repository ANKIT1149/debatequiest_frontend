...
const ContactCard = () => {
  ...
  return (
    <div className="w-full h-[90vh] bg-[#3d3a37] max-md:flex-col max-md:w-[96%] max-md:h-auto max-md:rounded-3xl max-md:ml-3 flex justify-between items-center">
      <div className="mx-10 px-5 max-md:mt-8">
      ...
      <div className="mx-10 mt-2 grid grid-cols-2 max-md:mt-4 max-md:mb-10">
        <Image
          src="/contact.png"
          alt="response"
          width={100}
          height={100}
          className="w-[400px] h-[400px] max-md:h-[300px] rounded-2xl ml-7 transition-all hover:scale-105 cursor-pointer hover:transition-transform hover:translate-x-6"
        />
        <Image
          ...
          width={100}
          height={100}
          className="w-[400px] h-[200px] max-md:w-[300px] mt-20 rounded-2xl transition-all hover:scale-105 cursor-pointer hover:transition-transform hover:translate-x-6"
        />
      </div>
    </div>
  );
